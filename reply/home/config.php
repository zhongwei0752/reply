...
define('UC_DBNAME', 'reply'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`reply`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'O1s3weh2s2n926f2ubj275p7w3J3w9QcA4lfH4C8uaXa8dG2Z9D0X5bfx8y0B4L7'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost/reply/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
